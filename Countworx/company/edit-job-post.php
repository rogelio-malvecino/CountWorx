      ...
      <div class="container">
        <div class="row">
          <div class="col-md-4 latest-job margin-bottom-20">
            ...
            <form method="post" action="update_edit_job_post.php">
          ...
          <?php
           ...
           ?>
                ...
                <input type="text" class="form-control shadow-none" name="id_jobpost" id="id_jobpost" placeholder="ID Jobpost" value="<?php echo $row['id_jobpost']; ?>" disabled >
                </div>
                <br>


                <div class="form-label-group in-border">
                <input type="text" class="form-control shadow-none" name="jobtitle" id="jobtitle" placeholder="Position Title" value="<?php echo $row['jobtitle']; ?>" required="true" autofocus >
                <label for="jobtitle">Position Title</label>
                </div>

                
			          <div class="form-label-group in-border">
                <input type="text" class="form-control shadow-none" name="job_location" id="job_location" placeholder="Work Location" value="<?php echo $row['job_location']; ?>">
                <label for="address">Work Location</label>
                </div>

                <div class="form-label-group in-border">
                <select class="form-control shadow-none" width="40" name="work_arrangement" id="work_arrangement" name="work_arrangement" placeholder="Work Setup">
                <option selected="<?php echo @$work_arrangement; ?>" value="<?php echo @$work_arrangement;?>"><?php echo @$work_arrangement;?></option>
                <?php
                ...
                <option selected="<?php echo @$experience; ?>" value="<?php echo @$experience;?>"><?php echo @$experience;?></option>    
                ...
                <option selected="<?php echo @$industry; ?>" value="<?php echo @$industry;?>"><?php echo @$industry;?></option>
                <?php
                ...
                <option selected="<?php echo @$salary; ?>" value="<?php echo @$salary;?>"><?php echo @$salary;?></option>
                ...
                <?php
                     ...
                     if($resultcertifications->num_rows > 0) {
                       while($rowcertifications = $resultcertifications->fetch_assoc()) {
                         ...
                         $getsql="SELECT * FROM compcertificationaccreditation WHERE certifications_accreditations = '$cert' AND id_jobpost='$id_jobpost' AND id_company = '$_SESSION[id_user]'";
                ...
                <?php
                    ...
                    if($resultskills->num_rows > 0) {
                      while($rowskills = $resultskills->fetch_assoc()) {
                        ...
                        $getsql="SELECT * FROM compskills WHERE skills = '$sk' AND id_jobpost='$id_jobpost' AND id_company = '$_SESSION[id_user]'";
                        $getresult=$conn->query($getsql);
                        if($getresult->num_rows > 0) {
                           $napili = 'selected';
                        }								
                ...
                <?php
                     ...
                     if($resultcore->num_rows > 0) {
                       while($rowcore = $resultcore->fetch_assoc()) {
                         ...
                         $getsql="SELECT * FROM compcorecompetencies WHERE core_competencies = '$cc' AND id_jobpost='$id_jobpost' AND id_company = '$_SESSION[id_user]'";
                         $getresult=$conn->query($getsql);
                         if($getresult->num_rows > 0) {
                            $napili = 'selected';
                         }
              ...
              <div class="col-md-8 corporate-profile margin-bottom-20">
                ...
                <div class="form-label-group in-border">
			          <textarea id="job_decription" name="job_decription" class="form-control shadow-none" rows="16" placeholder="job_decription" ><?php echo @$description;?></textarea>
                <label for="job_decription">Job Description</label>
                </div>
                <br>

                <div class="form-label-group in-border">
			          <textarea id="qualification" name="qualification" class="form-control shadow-none" rows="15" placeholder="qualification" ><?php echo @$qualification;?></textarea>
