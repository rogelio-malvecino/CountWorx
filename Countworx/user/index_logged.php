...
$sql = "SELECT * FROM users WHERE active='0' AND id_user='$_SESSION[id_user]'";
     ...
     <!-- <button type="submit" onclick="location.href = '#job-post'" class="btn btn-primary" id="btn_Search">Search</button> -->
      ...
      <script type = "text/javascript">  
          ...
          setTimeout(location.reload.bind(location), 400)
            ...
            <!--Smooth Scrool-->              
                <section class="content-header" id="success-applied"></section>            
      	     </div>
        </section>            
    </div>
      ...
      <div class="container">
        <div class="row">
          ...
          */
          ...
          //insert validation if user already applied-->
...
<?php
        ...
        if(isset($_SESSION['id_user'])) {
              ...
              $sql2 = "SELECT id_user FROM apply_job_post WHERE id_user='$_SESSION[id_user]' AND id_jobpost='$row[id_jobpost]'";
              $result2 = $conn->query($sql2);
                if($result2->num_rows > 0) 
                {
                  
                  echo "<span class='label label-warning'>Already Applied</span>&nbsp";
