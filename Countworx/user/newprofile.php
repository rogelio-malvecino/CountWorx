          ...
          <?php
            ...
            ?>
				...
				<!-- <form method="post" action="" enctype="multipart/form-data" id="profilepicform"> -->
					<div class='preview'>
						<img src="<?php echo $row['profilepic']; ?>" id="profileimg" width="100" height="100">
					</div>
					<div >
 ...
 <!-- for educational background -->
		  <div class="jcol-md-5 jwell">
            <div class="form-group">
				...
				<button id="btnrowaddeducbackground" >Add Educational Background<img src="../img/rowadd.png" width="20" height="20"></button>
            </div>
          </div>
            ...
            <div class="form-group">
				<table id="tblworkExperienced">
					...
					<td width="25%"><label for="positiontitle">Position Title</label><input type="text" class="form-control" value="<?php echo $row['positiontitle']?>"></td>
						...
						echo "<select class='form-control' id=role' name='role' width='20'>";
					...
					<!-- <td width="20%"><label for="otherbenefit">Other Benefit</label><input type="text" class="form-control" value=" --> <? //php echo $row['otherbenefit']?> <!-- "></td> -->
						<?php
						echo "<td width='25%'><label for='Benefit'>Benefit</label>";
						echo "<select class='form-control' id='test' name='test' width='20'>";
				...
				<button id="btnrowaddworkx" >Add Work Experience<img src="../img/rowadd.png" width="20" height="20"></button>
            </div>
          </div>
...
<!-- for seminar attended -->
		  <div class="jcol-md-5 jwell">
            <div class="form-group">
				...
				<button id="btnrowaddtrainingattended" >Add Seminar Attended<img src="../img/rowadd.png" width="20" height="20"></button>
            </div>
          </div>
...
<!-- for seminar attended -->
	   ...
	   <div class="text-center">
                <button type="submit" onclick="return false" class="btn btn-primary" id="btn_Update">Update</button>
