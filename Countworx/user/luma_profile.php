  ...
  <style> 
	...
	$(document).ready(function(){
		...
		$("#btnrowaddworkx").click(function(){
			...
			<td width='25%'><label for='benefits'>Benefits</label><select class='form-control' id='benefits' name='benefits' width='40'>"+benefits+"</select></td>\
			<td width='15%'><button class='jadddeleterow'><img src='../img/rowdelete.png' width='20' height='20'></button></td>\
			</tr>");
		});	
	...
	function getTabledata(){
		...
		$('#tblworkExperienced tr:not(:has(th))').each(function(row, tr){
			...
			var Benefits = $(tr).find('td:eq(9)').find('option:selected').val();
            ...
            <div class="form-group">
				<table id="tblworkExperienced">
					...
					<tr>
						...
						echo "<select class='select-toggle' id='corecompetency' name='corecompetency' multiple width='40'>";
...
<?php
						echo "<td width='25%'><label for='benefits'>Benefits</label>";
						echo "<select class='select-toggle' id='benefits' name='benefits' multiple width='40'>";
								$sql="SELECT * FROM benefits";
								$resultbenefits=$conn->query($sql);
								if($resultbenefits->num_rows > 0) {
									while($rowbenefits = $resultbenefits->fetch_assoc()) {
										$napili = '';
										/*if($rowbenefits['benefitname'] == $row['benefits']){$napili = 'selected';}*/
										echo "<option value='".$rowbenefits['benefitname']."' ".$napili." >".$rowbenefits['benefitname']."</option>";
									}
								}
						echo "</select>";
						echo "</td>";
				...
				<!-- Use for Multiple-Select Function to be added to dynamic row container 2-->		  
				<br /><br />
				 ...
				 <?php
                  		$sql="SELECT benefitname FROM benefits";
                  		$result=$conn->query($sql);

                  		if($result->num_rows > 0) {
                    		while($row = $result->fetch_assoc()) {
                      		echo "<option value='".$row['benefitname']."' >".$row['benefitname']."</option>";
                    		}
                  		}
                	?>
		  ...
		  <script>
			$(document).ready(function(){
 			$('#framework').multiselect({
  			nonSelectedText: 'Select Benefits',
    ...
    $('option',select).each(function(i, option){
		...
		<!-- Use for Multiple-Select Function to be added to dynamic row container 1-->
