...
$(document).ready(function(){
	...
	$("#btn_Search").click(function(){
		...
		$.ajax({
			...
			data: {jobTitle:jobTitle,selectIndustry:selectIndustry,jobstatus:jobstatus,loc:loc,yoe:yoe,qual:qual,salaryRangemin:salaryRangemin,salaryRangemax:salaryRangemax},
  ...
  <body>
          ...
          if(isset($_SESSION['id_user']) && empty($_SESSION['companyLogged'])) { 
              ...
              <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown" ><?php echo $_SESSION['name']; ?> <span class="glyphicon glyphicon-user pull-right"></span>
                ...
                <ul class="dropdown-menu ">
                    ...
                    <li><a href="profile.php" class="blue-text">Profile <span class="glyphicon glyphicon-folder-heart pull-right"></span></a></li>
                    <li class="divider"></li>
    ...
    <section>
      ...
      <button type="submit" onclick="location.href = '#job-post'" class="btn btn-primary" id="btn_Search">Search</button>
			<!--<button type="submit" onclick="return false" class="btn btn-primary" id="btn_Search">Search</button>-->
      ...
      <div class="container">
        <div class="row">
          ...
          */
          ...
          $sql = "SELECT * FROM job_post Order By createdat limit 10";
          $result = $conn->query($sql);
          if($result->num_rows > 0) {
            while($row = $result->fetch_assoc()) 
            {
