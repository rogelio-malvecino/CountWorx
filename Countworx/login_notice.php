      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center latest-job margin-bottom-20">
            ...
            echo "<strong><center>Info!</center></strong> <br>";
            echo "<center> Invalid Login. Your Account Is Not Activated. </center>";
            echo "<center> Please Wait For The Activation Notice from the Administrators. </center";
            echo "</div>";            
            ?>  
